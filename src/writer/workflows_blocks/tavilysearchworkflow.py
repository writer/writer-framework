...
class TavilySearch(WorkflowBlock):
    @classmethod
    def register(cls, type: str):
        super(TavilySearch, cls).register(type)
        register_abstract_template(type, AbstractTemplate(
            baseType="workflows_node",
            writer={
                "name": "Tavily Search",
                "description": "Executes a search query using the Tavily Search API.",
                "category": "Search",
                "fields": {
                    "api_key": {
                        "name": "API Key",
                        "type": "Text",
                        "description": "Your Tavily Search API key"
                    },
                    "query": {
                        "name": "Search Query",
                        "type": "Text",
