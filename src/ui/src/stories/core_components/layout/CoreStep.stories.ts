...
import Step from "../../../core_components/layout/CoreStep.vue";
...
const meta = {
	title: "core-components/layout/Step",
	component: Step,
	...
	render: (args) => ({
		...
		setup() {
			...
			provide(injectionKeys.evaluatedFields, {
				...
				isCompleted: computed(() => args.isCompleted),
		...
		template:
			'<Step :style="args.rootStyle" :prop-name="args.propName" />',
	}),
};
