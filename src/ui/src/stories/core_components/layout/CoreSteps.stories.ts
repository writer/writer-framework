...
import StepContainer from "../../../core_components/layout/CoreSteps.vue";
...
const meta = {
	title: "core-components/layout/StepContainer",
...
export const Sample: Story = {
	render: (args) => ({
		...
		template:
			'<StepContainer :style="args.rootStyle" :prop-name="args.propName" />',
	}),
};
