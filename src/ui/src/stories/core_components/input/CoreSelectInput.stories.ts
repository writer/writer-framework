...
import SelectInput from "../../../core_components/input/CoreSelectInput.vue";
...
const meta = {
	title: "core-components/input/SelectInput",
...
export const Sample: Story = {
	render: (args) => ({
		...
		template:
			'<SelectInput :style="args.rootStyle" :prop-name="args.propName" />',
	}),
};
