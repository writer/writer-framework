...
## Building your application in UI mode
...
### Building the UI with components
...
![](/framework/images/builder-basics.drag-drop-components.png)

![](/framework/images/builder-basics.component-search.png)

![](/framework/images/builder-basics.tree-search.png)
